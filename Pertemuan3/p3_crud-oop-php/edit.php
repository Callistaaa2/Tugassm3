  ...
  <body>
    <div class="container mt-3">
        ...
        <form method="POST" action="proses.php?aksi=update" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="poto" class="form-label fw-bold">Gambar</label>
                <br>
                <img src="poto/<?php echo $dataUser['poto']; ?>" alt="poto" width="100">
                <input type="file" class="form-control mt-2" name="poto" id="poto">
            </div>
            <?php
                }
            ?>
