...
$dataUser = mysqli_fetch_assoc(mysqli_query($db->connect, "SELECT * FROM tb_user_0035 WHERE id='$id'"));
?>
...
<body>
    <div class="container mt-3">
        ...
        <div class="card mb-3 bg-secondary bg-info-subtle" style="max-width: 100%;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="poto/<?php echo $dataUser['poto']; ?>" class="img-fluid rounded-start" alt="<?php echo $dataUser['nama']; ?>">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo "Nama : " . $dataUser['nama']; ?></h5>
